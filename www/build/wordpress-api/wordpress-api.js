...
window['wordpress-api'].loadComponents(
...
function Dexie(dbName, options) {
    ...
    */
    ...
    this._whenReady = function (fn) {
        return fake || openComplete || PSD.letThrough ? fn() : new Promise$1(function (resolve, reject) {
            if (!isBeingOpened) {
                if (!autoOpen) {
    ...
    props(Table.prototype, {
        ...
        _idbstore: function getIDBObjectStore(mode, fn, writeLocked) {
            if (fake)
                return new Promise$1(fn); // Simplify the work for Intellisense/Code completion.
    ...
    props(Collection.prototype, function () {
        ...
        return {
            ...
            count: function (cb) {
                if (fake)
                    return Promise$1.resolve(0).then(cb);
                var ctx = this._ctx;
...
class BaseAPI {
    constructor(url, endpoint, batchCount = 100) {
...
class Posts {
    ...
    compareState() {
        return __awaiter$2(this, void 0, void 0, function* () {
            let follower = yield this.db.posts.count();
    ...
    count() {
        return __awaiter$2(this, void 0, void 0, function* () {
            return yield this.db.posts.count();
        });
    }
    all() {
        return __awaiter$2(this, void 0, void 0, function* () {
    ...
    getBySlug(slug) {
        return __awaiter$2(this, void 0, void 0, function* () {
            console.debug('post in the db?');
            let post = yield this.db.posts.where("slug").equals(slug).first();
            if (!post) {
                console.debug('post on the app then?');
...
class Pages {
    ...
    compareState() {
        return __awaiter$4(this, void 0, void 0, function* () {
            let follower = yield this.db.pages.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
    ...
    count() {
        return __awaiter$4(this, void 0, void 0, function* () {
            return yield this.db.pages.count();
        });
    }
    all() {
        return __awaiter$4(this, void 0, void 0, function* () {
...
class Comments {
    ...
    compareState() {
        return __awaiter$5(this, void 0, void 0, function* () {
            let follower = yield this.db.comments.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
    ...
    count() {
        return __awaiter$5(this, void 0, void 0, function* () {
            return yield this.db.comments.count();
        });
    }
    all() {
        return __awaiter$5(this, void 0, void 0, function* () {
...
class Media {
    ...
    compareState() {
        return __awaiter$6(this, void 0, void 0, function* () {
            let follower = yield this.db.media.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
        ...
        return __awaiter$6(this, void 0, void 0, function* () {
            ...
            if (yield this.compareState()) {
                ...
                yield this.api.all().then((request) => {
                    ...
                    const iterations = Array.apply(null, { length: (request.totalPages - 1) });
                    iterations.forEach(() => __awaiter$6(this, void 0, void 0, function* () {
                        yield this.api.some({ limit: this.batchCount, page: currentPage++ }).then((request) => {
                            this.db.media.bulkPut(request.data).catch(Dexie.BulkError, (e) => {
                                console.debug(`Added ${this.batchCount - e.failures.length} new Media`);
                            });
    ...
    count() {
        return __awaiter$6(this, void 0, void 0, function* () {
            return yield this.db.media.count();
        });
    }
    all() {
        return __awaiter$6(this, void 0, void 0, function* () {
...
class Tags {
    ...
    compareState() {
        return __awaiter$7(this, void 0, void 0, function* () {
            let follower = yield this.db.tags.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
    ...
    count() {
        return __awaiter$7(this, void 0, void 0, function* () {
            return yield this.db.tags.count();
        });
    }
    all() {
        return __awaiter$7(this, void 0, void 0, function* () {
...
class Categories {
    ...
    compareState() {
        return __awaiter$8(this, void 0, void 0, function* () {
            let follower = yield this.db.categories.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
    ...
    count() {
        return __awaiter$8(this, void 0, void 0, function* () {
            return yield this.db.categories.count();
        });
    }
    all() {
        return __awaiter$8(this, void 0, void 0, function* () {
...
class Users {
    ...
    compareState() {
        return __awaiter$9(this, void 0, void 0, function* () {
            let follower = yield this.db.users.count();
            let leader = yield this.api.count();
            console.debug(this.endpoint, { "Follower": follower, "Leader": leader });
            return follower === leader;
        });
    ...
    count() {
        return __awaiter$9(this, void 0, void 0, function* () {
            return yield this.db.users.count();
        });
    }
    all() {
        return __awaiter$9(this, void 0, void 0, function* () {
...
exports['wordpress-api'] = WordpressApi;
},
