...
// Posts
class Posts extends BaseInteractor {
...
// Pages
class Pages extends BaseInteractor {
    constructor(db, url = "/", nonce) {
        super(db, db.pages);
        this.endpoint = "/pages";
        this.singular = "Page";
...
// Comments
class Comments extends BaseInteractor {
    constructor(db, url = "/", nonce) {
...
// Media
class Media extends BaseInteractor {
    constructor(db, url = "/", nonce) {
        super(db, db.media);
        this.endpoint = "/media";
        this.singular = "Media";
...
// Tags
class Tags extends BaseInteractor {
    constructor(db, url = "/", nonce) {
        super(db, db.tags);
        this.endpoint = "/tags";
        this.singular = "Post";
...
// Categories
class Categories extends BaseInteractor {
    constructor(db, url = "/", nonce) {
...
// Users
class Users extends BaseInteractor {
    constructor(db, url = "/", nonce) {
        super(db, db.users);
        this.endpoint = "/users";
        this.singular = "Post";
...
[
  [ "api", /** prop mutable **/ 2, /** observe attribute **/ 1, /** type any **/ 1 ],
  [ "baseUrl", /** prop **/ 1, /** observe attribute **/ 1, /** type string **/ 2 ],
  [ "cookie", /** state **/ 5, /** do not observe attribute **/ 0, /** type any **/ 1 ],
  [ "name", /** prop **/ 1, /** observe attribute **/ 1, /** type string **/ 2 ],
  [ "nonce", /** prop **/ 1, /** observe attribute **/ 1, /** type string **/ 2 ],
  [ "prepare", /** method **/ 6, /** do not observe attribute **/ 0, /** type any **/ 1 ],
  [ "ready", /** state **/ 5, /** do not observe attribute **/ 0, /** type any **/ 1 ],
  [ "signedIn", /** method **/ 6, /** do not observe attribute **/ 0, /** type any **/ 1 ],
